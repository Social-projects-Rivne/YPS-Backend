...
namespace YPS.Application.Parents.Queries.GetParentProfileInfo
{
    ...
    {
        public long Id;
        public class GetParentProfileInfoQueryHandler : IRequestHandler<GetParentProfileInfoQuery, GetParentProfileInfoVm>
        {
            ...
            public async Task<GetParentProfileInfoVm> Handle(GetParentProfileInfoQuery request, CancellationToken cancellationToken)
            {
